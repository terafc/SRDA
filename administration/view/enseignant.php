...
<div class="articles">
	<form class="inscrire" action="<?php echo HTTP_URL;?>/enseignant/create" method="post">
		<fieldset>
...
<br/>
<div class="articles">
	<form class="inscrire" action="<?php echo HTTP_URL;?>/enseignant/delete" method="post">
		<fieldset>
			...
			<ol>
				<li>
					...
					<td><textarea id="autoEns" class="inlineBlockTop" placeholder="Entrer un nom suivi d'un prénom ou une promotion..." name="listeId" required="required"></textarea></td>
				</li>
			</ol>	
		</fieldset>
		<fieldset>
